...
if ($showRegister && $_POST['register']) {
    ...
    if (empty($name) || empty($email) || empty($password)) {
        ...
        $result = $auth->createUser($email, $password, $name, 'admin');
...
<head>
    ...
    <title>Login - Sistema de Notificaciones Push</title>
            ...
            <div class="col-md-6 col-lg-5">
                <div class="login-card">
                    <div class="login-header">
                        ...
                        <p class="mb-0">Sistema de gestión de notificaciones</p>
                    </div>
                            ...
                            <?php if ($userCount == 0): ?>
                                <div class="text-center mt-3">
                                    <small class="text-muted">
                                        ...
                                        No hay usuarios registrados. Crea la primera cuenta.
                                    </small>
                                </div>
                            <?php endif; ?>
                        <?php endif; ?>
